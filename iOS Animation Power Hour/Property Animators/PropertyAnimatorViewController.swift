...
class PropertyAnimatorViewController: StackViewViewController {
...
extension PropertyAnimatorViewController {
    func createBasicsSection() -> DemoSectionView {
        ...
        let shortDesc = "The basics of creating a property animator."
    ...
    func createStatesSection() -> DemoSectionView {
        ...
        let shortDesc = "Navigating the cryptic states of a property animator: 'inactive', 'active', 'stopped', and the separate (but related) 'is running' boolean."
    ...
    func createReverseSection() -> DemoSectionView {
        ...
        let shortDesc = "Flipping an animation's direction to allow them to reverse."
    ...
    func createScrubbingSection() -> DemoSectionView {
        ...
        let shortDesc = "Using external values to scrub an animation or set it to any point in its duration."
        ...
        let animationSection = DemoSectionView(title: sectionTitle, description: description, sampleCode: sampleCode, animationExampleView: animationExampleView, actions: [sliderAction])
    ...
    func createAddAnimationSection() -> DemoSectionView {
        ...
        let shortDesc = "Adding additional animations and completion blocks to an animation while it's running."
    ...
    func createTimingCurvesSection() -> DemoSectionView {
        ...
        let shortDesc = "Using control points to create custom Bézier curves to animate along."
    ...
    func createTimingObjectsSection() -> DemoSectionView {
        ...
        let shortDesc = "Storing animation parameters into a convenient, reusable package for using the same animations in different places.s"
        ...
        var startAction, resetAction: DemoSectionViewButtonAction?
