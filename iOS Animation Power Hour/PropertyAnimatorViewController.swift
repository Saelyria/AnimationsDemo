...
class PropertyAnimatorViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.sections.append(providersSection)
...
extension PropertyAnimatorViewController {
    ...
    func createTimingCurvesSection() -> DemoSectionView {
        ...
        let animationExampleView = AnimationExampleView(withComponents: [.redSquare, .bezierView])
        let square = animationExampleView.redSquares.first!
        let bezierView = animationExampleView.bezierView!
        //bezierView.alpha = 0
        ...
        firstBezierAction = DemoSectionViewButtonAction(buttonTitle: "Animate Bézier 1", actionBlock: {
            ...
            bezierView.setup(withControlPoint1: controlPoint1, controlPoint2: controlPoint2)
