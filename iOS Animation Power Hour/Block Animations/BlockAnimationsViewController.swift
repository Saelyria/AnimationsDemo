...
class BlockAnimationsViewController: StackViewViewController {
...
fileprivate extension BlockAnimationsViewController {
    func createBasicsSection() -> ExampleViewCell {
        ...
        let shortDesc = "The basic syntax of a block-based animation, demonstrated by animating the alpha and background color of a square."
        ...
        let action = ExampleViewControllerButtonAction(buttonTitle: "Animate", actionBlock: {
        ...
        let cell = ExampleViewCell(title: sectionTitle, description: shortDesc, onTapAction: {
            let animationSection = ExampleViewController(title: sectionTitle, description: description, sampleCode: sampleCode, animationExampleView: animationExampleView, actions: [action])
    ...
    func createFrameSection() -> ExampleViewCell {
        let sectionTitle = "Frame and Bounds"
        let shortDesc = "The differences between a view's frame and bounds, basics on coordinate systems, and how to animate them."
        ...
        let frameAction = ExampleViewControllerButtonAction(buttonTitle: "Animate Frame", actionBlock: {
        ...
        let boundsAction = ExampleViewControllerButtonAction(buttonTitle: "Animate Bounds", actionBlock: {
    ...
    func createTransformSection() -> ExampleViewCell {
        let sectionTitle = "Transform"
        let shortDesc = "Animating the translation, rotation, or scaling of a view."
        ...
        var rotateAction, scaleAction, translateAction, resetAction: ExampleViewControllerButtonAction?
        translateAction = ExampleViewControllerButtonAction(buttonTitle: "Animate translation", actionBlock: {
        ...
        rotateAction = ExampleViewControllerButtonAction(buttonTitle: "Animate rotation", actionBlock: {
            translateAction?.button?.isEnabled = false
            rotateAction?.button?.isEnabled = false
            scaleAction?.button?.isEnabled = false
            resetAction?.button?.isEnabled = true
        ...
        scaleAction = ExampleViewControllerButtonAction(buttonTitle: "Animate scale", actionBlock: {
            translateAction?.button?.isEnabled = false
            rotateAction?.button?.isEnabled = false
            scaleAction?.button?.isEnabled = false
            resetAction?.button?.isEnabled = true
    ...
    func createMultiTransformSection() -> ExampleViewCell {
        let sectionTitle = "Multiple Transforms"
        let shortDesc = "Animating multiple affine transforms at the same time."
        ...
        var rotateThenTranslateAction, translateThenRotateAction, resetAction: ExampleViewControllerButtonAction?
        rotateThenTranslateAction = ExampleViewControllerButtonAction(buttonTitle: "Rotate then Translate", actionBlock: {
        ...
        translateThenRotateAction = ExampleViewControllerButtonAction(buttonTitle: "Translate then Rotate", actionBlock: {
            rotateThenTranslateAction?.button?.isEnabled = false
            translateThenRotateAction?.button?.isEnabled = false
            resetAction?.button?.isEnabled = true
    ...
    func createOptionsRepeatingSection() -> ExampleViewCell {
        let sectionTitle = "Repeating"
        let shortDesc = "Setting an animation to automatically repeat and reverse itself."
        ...
        var animateAction, stopAnimateAction: ExampleViewControllerButtonAction?
        animateAction = ExampleViewControllerButtonAction(buttonTitle: "Animate", actionBlock: {
        ...
        stopAnimateAction = ExampleViewControllerButtonAction(buttonTitle: "Stop", startsEnabled: false, actionBlock: {
        ...
        let cell = ExampleViewCell(title: sectionTitle, description: shortDesc, onTapAction: {
            let animationSection = ExampleViewController(title: sectionTitle, description: description, sampleCode: sampleCode, animationExampleView: animationExampleView, actions: [animateAction!, stopAnimateAction!])
            self.navigationController?.pushViewController(animationSection, animated: true)
        })
    ...
    func createOptionsCurrentStateSection() -> ExampleViewCell {
        let sectionTitle = "Competing Animations"
        let shortDesc = "Dealing with animations that animate the same property of a view."
    ...
    func createOptionsCurvesSection() -> ExampleViewCell {
        let sectionTitle = "Animation Curves"
        let shortDesc = "Using built-in animation curves to make animations look a little more natural."
    ...
    func createSpringDampingSection() -> ExampleViewCell {
        let sectionTitle = "Spring Animations - Damping"
        let shortDesc = "Creating a springing animation and using damping to adjust how springy the animation is."
    ...
    func createSpringVelocitySection() -> ExampleViewCell {
        let sectionTitle = "Spring Animations - Velocity"
        let shortDesc = "Adjusting the takeoff speed of a spring animation."
